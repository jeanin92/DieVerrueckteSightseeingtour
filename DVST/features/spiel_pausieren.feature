...
#	Will ich das laufende Spiel unterbrechen koennen ohne den Spielstand zu verlieren
#	So dass ich angefangenes Spiel weiterspielen kann, nachdem ich es unterbrochen habe.
	
#	Szenario: Der Benutzer pausiert das laufende Spiel,in dem er die App schließt und diese im Hintergrund weiterlaeuft.
